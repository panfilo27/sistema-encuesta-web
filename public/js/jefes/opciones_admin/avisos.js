...
if (typeof window.AvisosModule !== 'undefined') {
    ...
    // Función para cargar carreras desde Firestore para el selector
    async function cargarCarrerasSelector() {
        try {
            elementos.selectCarrera.innerHTML = '<option value="">Todas las Carreras</option>';
    ...
    // Función para cargar avisos desde Firestore
